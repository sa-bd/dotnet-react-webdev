...
- [Creating a dotnet project template](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#creating-a-dotnet-project-template)
- [How Controllers work](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#how-controllers-work)
- [Adding MongoDB](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#adding-mongodb)
- [Creating User accounts](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#creating-user-accounts)
- [Creating a JWT token](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#creating-a-jwt-token)
- [Custom Middleware Authentication](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#custom-middleware-authentication)
- [Creating Authenticated Endpoints & Cloud Bucket](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles#creating-authenticated-endpoints)
...
We first need to create the react project. Since this workshop mainly focuses on the backend development, we are going to use a pre-existing react application that can be found [here](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles/01_client). 
...
```
That's it for the workshop. You can find the completed project [here](https://github.com/sa-bd/dotnet-react-webdev/tree/main/Resources/ProjectFiles/03_completed_project)
